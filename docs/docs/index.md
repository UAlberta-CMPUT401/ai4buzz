...
> **As** a user, **I want** to get the colour scheme analysis of an image **so that** I can know how color affects popularity of an image.
...
> **As** a user, **I want** to be able to know the number of faces detected in a photo **so that** I can know how the number of people affects popularity.
...
- US 1.10 - Webclient image upload
- US 1.11 - Webclient analysis
- US 1.12 - Web client view collage
- US 1.13 - Web client view dendrogram
- US 1.14 - Web client authentication
- US 1.15 - Web client image upload
